...
function Navbar() {
  ...
  const getHref = (l) => {
    if (l === "Apartments") return "/apartments";
    if (l === "Language School") return "#language-school";
    return "#";
  };
    ...
    <>
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            {NAV_LINKS.map(l => (
              <a key={l} href={l === "Language School" ? "#language-school" : "#"} onClick={e => { e.preventDefault(); setActiveLink(l); setMenuOpen(false); }}>{l}</a>
            ))}
  ...
  return (
    <section
      style={{
        ...
        minHeight: "600px", overflow: "hidden", paddingTop: "72px",
      }}
    >
      {HERO_SLIDES.map((src, i) => (
        <img key={src} src={src} alt=""
          style={{
            ...
            transition: "opacity 1.4s ease-in-out", zIndex: 0,
          }}
        />
      ))}
      ...
      <div style={{
        ...
        >
          ...
          <a href="#contact"
            style={{
              display: "inline-flex", alignItems: "center", gap: "10px",
              padding: "15px 32px", border: "1px solid rgba(245,240,232,0.4)", color: "rgba(245,240,232,0.88)",
              fontSize: "11px", letterSpacing: "0.14em", textTransform: "uppercase",
        ...
        {FEATURES.map(({ label, icon }, i) => (
          <motion.div
            ...
            style={{
              ...
              borderRight: i < FEATURES.length - 1 ? "1px solid rgba(139,107,71,0.07)" : "none",
            }}
          >
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={visible ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9, delay: 0.15 }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
              {[
                ...
                <motion.div key={src} className="card-wrap"
                ...
                >
                  <img src={src} alt={alt} className="card-img"
                    style={{ width: "100%", height: "240px", objectFit: "cover", objectPosition: "center", display: "block" }}
                  />
                </motion.div>
              ))}
            </div>
...
/* ─────────────────────────────────────────────
   GERMAN LANGUAGE SCHOOL  ← NEW SECTION
───────────────────────────────────────────── */
const LANG_FEATURES = [
  {
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>,
    label: "All Levels",
    desc: "Beginner to advanced — structured courses for every starting point.",
  },
  {
    ...
    desc: "Morning, evening, and weekend classes designed around your lifestyle.",
  },
  {
    ...
    desc: "Learn from certified native-speaking German tutors and educators.",
  },
  {
    ...
    desc: "Interactive digital tools, cultural sessions, and real-world practice.",
  },
  {
    ...
    label: "Certification",
    desc: "Earn recognised language certificates to support study or work abroad.",
  },
  {
    ...
    label: "Visa & Study Prep",
    desc: "Dedicated support for those planning to study or relocate to Germany.",
  },
];
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          ...
          <div className="lang-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "flex-end" }}>
            <motion.h2 className="serif"
              ...
              style={{ fontSize: "clamp(30px, 3.5vw, 52px)", lineHeight: 1.1, fontWeight: 500, color: "var(--charcoal)" }}
            >
            ...
            >
              ...
              <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
                <a href="#contact" className="btn-gold">Enrol Now</a>
                <a href="#" className="btn-outline">View Programmes</a>
              </div>
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            ...
            background: "var(--sand)", border: "1px solid rgba(139,107,71,0.1)",
            borderRadius: "6px", overflow: "hidden",
          }}
        >
          {[["A1–C2", "CEFR Levels Covered"], ["100+", "Graduates"], ["3", "Intakes Per Year"], ["1:1", "Tutoring Available"]].map(([num, label], i, arr) => (
            <div key={label} style={{
              flex: "1", minWidth: "140px", padding: "28px 24px", textAlign: "center",
              borderRight: i < arr.length - 1 ? "1px solid rgba(139,107,71,0.1)" : "none",
            }}>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1fr 1.2fr", gap: "48px", marginBottom: "48px", alignItems: "start" }}>
          ...
          <div>
            ...
            {["Apartments","Hotel","Restaurant","Creative Studio","Tech Hub","Language School","Gallery"].map(l => (
              <a key={l} href={l === "Language School" ? "#language-school" : "#"} className="footer-link">{l}</a>
            ))}
          </div>
...
function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/2347033869555"
      target="_blank"
